...
public class Admin extends javax.swing.JFrame {
    ...
    public Admin() {
        ...
        // Update tables with dummy data or remove the calls
    ...
    // Add dummy data
    Object[] row1 = {"123456789", "Doe", "John", "1990-01-01", "123 Main St", "555-1234", "john.doe@example.com"};
    Object[] row2 = {"987654321", "Smith", "Jane", "1985-05-15", "456 Elm St", "555-5678", "jane.smith@example.com"};
    Object[] row3 = {"456789123", "Brown", "Chris", "1978-12-30", "789 Oak St", "555-9101", "chris.brown@example.com"};
    ...
    private void Update_table_employe() {
     ...
     // Add dummy data
     Object[] row1 = {"1", "Johnson", "Michael", "Médical", "Cardiologie", "5", "michael.johnson", "password123"};
     Object[] row2 = {"2", "Williams", "Sarah", "Paramédical", "Infirmière", "3", "sarah.williams", "password456"};
     Object[] row3 = {"3", "Davis", "Robert", "Médical", "Neurologie", "10", "robert.davis", "password789"};
    ...
    // Add dummy data
    Object[] row1 = {"101", "123456789", "2023-10-01", "10:00", "Médical", "Cardiologie", "confirmée"};
    Object[] row2 = {"102", "987654321", "2023-10-02", "11:00", "Paramédical", "Infirmière", "Non confirmée"};
    Object[] row3 = {"103", "456789123", "2023-10-03", "12:00", "Médical", "Neurologie", "confirmée"};
    ...
    // Add dummy data
    Object[] row1 = {"201", "123456789", "2023-10-01", "10:00", "Cardiologie"};
    Object[] row2 = {"202", "987654321", "2023-10-02", "11:00", "Infirmière"};
    Object[] row3 = {"203", "456789123", "2023-10-03", "12:00", "Neurologie"};
    ...
    public void ResAnnulee() {
        ResAnul.setText("2"); // Exemple de valeur pour le taux de réservations annulées
    }

    public void nbrvisiteEmp() {
        nbVisites.setText("5"); // Exemple de nombre de visites pour un employé
    }

    public void nbrvisitePat() {
        nbVisitesPat.setText("3"); // Exemple de nombre de visites pour un patient
    }
    ...
    private void initComponents() {
        ...
        consultation_Table.setBackground(new java.awt.Color(204, 255, 204));
        ...
        CommentairejTextArea.setBackground(new java.awt.Color(204, 255, 153));
